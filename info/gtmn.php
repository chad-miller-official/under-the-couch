			...
			<section class="focus-content">
				<article>
					...
					<ul>
						...
						<li>A professional recording studio</li>
					...
					<b>Membership:</b>
					<ul>
						<li>$10.00 per Georgia Tech student per year.</li>
					</ul>
					<b>Practice Space:</b>
					<ul>
						<li>$15.00 per member of band per semester.</li>
						<li>Bands are required to send 1 member to the MN meeting on Monday nights at 7PM to
						request practice space. Space is booked up to 1 week in advance.</li>
					</ul>
					<b>Recording Time:</b>
					<ul>
						<li>$5.00 per hour.</li>
						<li>This fee <u>does not</u> include an engineer for the session. Engineers at Under the Couch
						usually charge between $10 and $15 per hour. To be cleared to be your own engineer, you must
						complete the recording class. Contact the Equipment Officer for more details on the recording
						class.</li>
					</ul>
				</article>
			</section>
